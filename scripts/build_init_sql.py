...
def main():
    ...
    lines.append("INSERT INTO wines (name, category_id, winery, country, vintage, grape, rating, shelf_price, sale_price, notes, image_url, out_of_stock) VALUES")
    wine_vals = []
    for w in data['wines']:
        ...
        wine_vals.append(
            ...
            f"{w['shelf_price']}, {w['sale_price']}, {esc(w.get('notes'))}, {esc(w.get('image_url'))}, 0)"
        )
    lines.append(',\n'.join(wine_vals) + ';')
