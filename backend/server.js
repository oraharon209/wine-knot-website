...
const allowedOrigins = (process.env.CORS_ORIGINS || 'http://localhost:8080,http://localhost:8089,http://localhost:8090,https://wineknot.co.il,https://new.wineknot.co.il')
  .split(',')
  .map((o) => o.trim())
  .filter(Boolean);
